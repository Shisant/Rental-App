...
<body>
  ...
  <ul>
    ...
    <li><?php if(!isset($_SESSION['username'])) { ?>
      ...
      <?php  if(isset($_SESSION['username'])) { ?>
          ...
          <?php echo strtoupper($first_name_login)." ".strtoupper($last_name_login) ?>
          </a>
      <?php } ?>
    </li>
    <li><?php  if(!isset($_SESSION['username'])) { ?>
  ...
  <div id="accomodate" class="modal tagline">
   <div class="modal-content m-container">
    ...
    <div id="visit" class="modal tagline">
   <div class="modal-content m-container">
       <div class="avl-heading">
           <h4>BE OUR MEMBER</h4>
           <div></div>
		...
		<div class="row">
		  <div class="col s7 m6 l7 pd-0">
			  ...
			  <ul class="disc">
				...
				<li><i class="material-icons">location_on</i>  &nbsp; <?php echo $location." ".$state ?></li>
			  </ul>
		  </div>
  ...
  $likes = "like.php?id=$house_id"

   ?>

 <li>
    <?php if(!isset($_SESSION['username'])) { ?>
    <a href="#visit" class="btn waves-effect waves-light theme-color-bg" name="action">Visit House
      <i class="material-icons right">send</i>
    </a>
    <a href="#visit" class="btn waves-effect waves-light theme-color-bg" name="action">Like
    ...
    <a href="<?php echo "$likes"?> " class="btn waves-effect waves-light theme-color-bg" name="action">Like
    <i class="material-icons right">favorite</i>
    </a>
              <?php } ?>
        </li>
