...
$value="Verified";
  ...
  $user_houses_sql = "SELECT * FROM houses WHERE user_id = '".$user_id."' AND verify='".$value."' ";
...
<body>
  ...
  <div class="tagline">
    ...
    <p>You can view your post here.</p>
  </div>
  </div>
      ...
      <div class="card horizontal">
        ...
        <div class="card-content">
          ...
          <div class="row no-margin">
            ...
            <?php
                  $delete = "deleteproperty.php?id=$id"
                ?>
            <a href="<?php echo "$delete"?> " class="btn waves-effect waves-light theme-color-bg" name="action">Delete Post
