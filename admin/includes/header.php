                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li <?php echo (CURRENT_PAGE == "customers.php" || CURRENT_PAGE == "add_customer.php") ? 'class="active"' : ''; ?>>
                                 ...
                                 <li <?php echo (CURRENT_PAGE == "customers.php" || CURRENT_PAGE == "add_customer.php") ? 'class="active"' : ''; ?>>
                                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i> Properties<span class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="properties.php"><i class="fa fa-list fa-fw"></i>List all</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="admin_users.php"><i class="fa fa-users fa-fw"></i> Admin Users</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.sidebar-collapse -->
